(function () {
    ...
    Handlebars.registerHelper("formatDateSpecial", function (value) {
        if (!value) return ''; var byDate = new Date(value); return new Handlebars.SafeString(byDate.format("DD MMMM YYYY") + ' ' + Handlebars.getGeneralDifference(byDate));
    });

    Handlebars.registerHelper("formatDateTimeSpecial", function (value) {
        if (!value) return ''; var byDate = new Date(value); return new Handlebars.SafeString(byDate.format("DD MMMM YYYY HH:mm") + ' ' + Handlebars.getGeneralDifference(byDate));
    });
    ...
    //Handlebars.registerPartial("generateRoom", px.GetObject("roomTemplate"));
